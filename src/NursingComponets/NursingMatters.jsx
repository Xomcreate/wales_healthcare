...
function NursingMatters() {
  return (
    // Section with the dark background, image overlay, and nursing writeup & button
    <section className="relative bg-slate-900 py-12 lg:py-16 overflow-hidden font-sans border-b border-slate-800 text-center">
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('https://i.pinimg.com/1200x/da/fc/fa/dafcfa7b27d405d40a1e07e12bb8542d.jpg')",
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="space-y-6">
          ...
          <div className="pt-1">
            ...
            >
              <span>Speak with our team to discuss your care needs</span>
            </a>
          </div>
