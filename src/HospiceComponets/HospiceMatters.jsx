...
function HospiceMatters() {
  return (
    // Section with the dark background, image overlay, and updated hospice writeup & button
    <section className="relative bg-slate-900 py-12 lg:py-16 overflow-hidden font-sans border-b border-slate-800 text-center">
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('https://i.pinimg.com/736x/79/d5/53/79d553b474b7dd3714959eb87766c9a1.jpg')",
