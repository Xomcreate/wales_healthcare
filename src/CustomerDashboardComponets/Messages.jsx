...
const thread = [
  { from: "franchise", text: "Hi Mary, your caregiver for tomorrow is Sarah Lee.", time: "9:12 AM" },
  { from: "me", text: "Great, thank you for confirming!", time: "9:20 AM" },
  { from: "franchise", text: "Your invoice #1042 is now available in your portal.", time: "Yesterday" },
];
  ...
  return (
    <div className="flex h-[65vh] flex-col rounded-2xl border border-slate-200/80 bg-white shadow-xs">
      <div className="border-b border-slate-100 px-5 py-4">
        <h3 className="text-sm font-black text-slate-900">Toronto West Franchise</h3>
        <p className="text-[11px] text-slate-400">Usually responds within a few hours</p>
      </div>
