      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 space-y-3">
          ...
          <p className="text-sm sm:text-base text-slate-300 leading-relaxed">
            Wales Healthcare proudly delivers trusted in-home care and professional healthcare staffing solutions throughout Ontario, Quebec, and British Columbia.
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-slate-800 p-2.5 sm:p-3 rounded-2xl border border-slate-700 shadow-2xl overflow-hidden relative">
            ...
            <div className="relative w-full h-65 sm:h-80 lg:h-92.5 rounded-xl overflow-hidden bg-slate-900">
              ...
              <div className="absolute bottom-3 left-3 bg-slate-900/90 backdrop-blur-xs border border-slate-700 px-3 py-1.5 rounded-xl text-[11px] font-semibold text-slate-200 shadow-md">
