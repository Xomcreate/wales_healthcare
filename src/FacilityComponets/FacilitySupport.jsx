  ...
  const features = [
    {
      ...
      description: "Fostering genuine human connection to alleviate isolation and uplift everyday emotional wellness.",
      icon: (
    ...
    {
      title: "Tailored Individual Care",
      description: "Delivering focused, one-on-one attention explicitly customized around personal preferences and routines.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      title: "Total Family Reassurance",
      description: "Keeping loved ones completely informed, anchored, and confident in their family member's daily quality of life.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      title: "Active Advocacy & Liaison",
      description: "Serving as a strong voice to articulate preferences and coordinate seamlessly with facility personnel.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <div className="space-y-2 flex flex-col items-center lg:items-start">
              <div className="inline-flex items-center space-x-2 bg-teal-500/10 border border-teal-500/30 px-3 py-0.5 rounded-full text-xs font-semibold tracking-wider uppercase text-teal-300">
                ...
                <span>Specialized Care Architecture</span>
              </div>
              <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-white">
                Elevating Resident Comfort and Connection in <span className="text-teal-300">Modern Care Settings</span>
              </h2>
            </div>
