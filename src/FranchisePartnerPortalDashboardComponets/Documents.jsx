...
function ComplianceTab({ error, setError }) {
  ...
  const statusBadgeClass = (status) => {
    ...
    if (normalized.includes("awaiting") || normalized.includes("missing")) return "bg-slate-100 text-slate-600";
...
//   Tab 2: Customers     — franchise uploads docs to a customer
// =========================================================
    ...
    >
      ...
      <div className="border-b border-slate-100 pb-6">
        ...
        <p className="text-xs text-slate-500 mt-1">
          Manage your franchise's compliance documents, and share files directly with your customers.
        </p>
