...
function PersonalMatters() {
  return (
    // Section with the dark background, image overlay, and updated teal button
    <section className="relative bg-slate-900 py-12 lg:py-16 overflow-hidden font-sans border-b border-slate-800 text-center">
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('https://i.pinimg.com/1200x/70/e4/23/70e4230960bd04ab55e1d92788143f0b.jpg')",
...
export default PersonalMatters;