...
function CareerForm() {
  ...
  const handleChange = (e) => {
    ...
    // Clear previous error when user changes something
    if (submitError) {
      setSubmitError('')
    }
  }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.response) {
        ...
        setSubmitError(
          'Unable to connect to the Wales Healthcare server. Please make sure the backend is running.'
        )
      } else {
        setSubmitError(
          ...
          <form onSubmit={handleSubmit} className="space-y-4 pt-6">
              ...
              <div className="flex items-center justify-center w-full">
                ...
                <label className="flex flex-col items-center justify-center w-full h-28 border-2 border-slate-300 border-dashed rounded-xl cursor-pointer bg-slate-50 hover:bg-slate-100 transition-all">
                  ...
                  <div className="flex flex-col items-center justify-center pt-3 pb-4 px-4 text-center">
                    ...
                    <svg
                      className="w-6 h-6 mb-1.5 text-teal-600"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
            ...
            <div className="flex space-x-3 pt-3">
              ...
              <button
                ...
                className="w-1/3 bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium py-3.5 rounded-xl transition-colors text-sm disabled:opacity-50"
              >
                Back
              </button>
