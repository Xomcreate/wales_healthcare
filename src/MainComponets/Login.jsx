...
const SLIDES = [
  {
    ...
    subtitle:
      'Access your health records, appointments, and care coordinators effortlessly.',
  },
  {
    image:
      'https://i.pinimg.com/1200x/12/92/bf/1292bf366eead999951a9a6cc70d2797.jpg',
    title: 'Advanced Professional Network',
    subtitle:
      'Empowering specialized practitioners with high-security facility tools.',
  },
  {
    image:
      'https://i.pinimg.com/1200x/73/ee/fa/73eefa2afd327d19ef5c9b0c9eaa1460.jpg',
    title: 'Holistic Home Support Portal',
    subtitle:
      'Bridging families and healthcare specialists with trust and precision.',
  },
]
...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      } else if (ROLE_DASHBOARDS[userRole]) {
                ...
                (_, index) => (
                  ...
                  <button
                    ...
                    className={`h-1.5 rounded-full transition-all duration-500 ${
                      index === currentSlide
                        ? 'w-10 bg-teal-400 shadow-[0_0_10px_rgba(45,212,191,0.6)]'
